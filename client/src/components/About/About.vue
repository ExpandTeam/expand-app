...
<div class="w3-center w3-blue" style="padding: 20px; margin: 20px;">
  <div class="w3-right w3-center w3-animate-zoom" style="padding: 60px;">
    <h1 class="w3-middle" style="padding: 10px; font-size: 96px;">👍 Oh yeah.</h1>
    <h2>You had best be expanding right now.</h2>
 </div>
  <br>
